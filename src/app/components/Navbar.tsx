      ...
      {mobileMenuOpen && (
        <div className="md:hidden mt-4 py-2 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col space-y-3">
            <Link 
              href="/songs" 
              className="text-lg py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-700 rounded"
            ...
            <Link 
              href="/songs/create" 
              className="text-lg py-2 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded"
              onClick={handleLinkClick}
            >
              Create Song
            </Link>
            ...
            <div className="py-2 px-4">
              <div className="flex flex-col">
                <span className="text-lg mb-2">Font Size</span>
                <div className="flex items-center">
                  <button
                    onClick={decreaseFontSize}
                    className="p-2 bg-gray-100 dark:bg-gray-700 rounded-l"
                  ...
                  <div className="px-4 py-2 bg-gray-200 dark:bg-gray-600 text-center">
                    {fontSize}px
                  </div>
                  <button
                    onClick={increaseFontSize}
